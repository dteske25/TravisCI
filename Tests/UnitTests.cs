...
namespace TravisCILab
{
    ...
    public class Math
    {
        ...
        public void Subtract_Valid()
        {
            ...
            Assert.AreEqual(59, Program.Subtract("89", "30"));
        }
        ...
        public void Multiply_Valid()
        {
            ...
            Assert.AreEqual(57, Program.Multiply("3", "19"));
        }
        ...
        {
            Assert.AreEqual(2, Program.Divide("5", "2.5"));
            Assert.AreEqual(4, Program.Divide("12", "3"));
            Assert.AreEqual(40, Program.Divide("200", "5"));
        }
